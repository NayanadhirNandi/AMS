...
<nav>
      <div class="logo">
      <h2><a href="index.html">Assignment Management System</a></h2>
    </div>
            ...
            <div class="login__inputs">
              ...
              <div>
                ...
                <div class="login__box">
                  <input class="login__input" type="password" name="password" id="password" placeholder="Enter your password" required />
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT * FROM teacher_details WHERE email='$input_email'";
