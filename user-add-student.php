            ...
            <form action="student_signup.php" method="post">
                ...
                <div class="form first">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Regional Centre Code:</label>
                            <input type="text" placeholder="Enter Regional Code" name="reg_cen_code" required>
                        </div>
                        <div class="input-field">
                            <label>Study Centre Name:</label>
                            <input type="text" placeholder="Enter Study Centre Name" name="study_centre" required>
                        </div>
                        ...
                        <div class="input-field register">
                            <button name="Register" class="sign" type="submit"
                                onclick="alert('Do You Want to Submit all the Data?')">Register</button>
                        </div>
                        <div class="input-field reset">
                            <button name="resetbutton" style="font-size: 13pt;" type="reset"
                                onclick="alert('Do You Want to all Reset the Data?')">Reset</button>
                        </div>
                    </div>
        ...
        <script>
            function populateSubjects() {
                ...
                if (programSelect.value === "B.Sc.") {
                    var bscSubjects = [ "Computer Science", "Chemistry", "Mathematics", "Physics", "Microbiology", "Zoology"];
